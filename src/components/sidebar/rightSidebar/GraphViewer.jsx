...
const GraphViewer = memo(function GraphViewer({ graphData = null }) {
  ...
  useEffect(() => {
    ...
    console.log('📊 GraphViewer - graphData recibido:', JSON.stringify(graphData, null, 2));
    console.log('📊 GraphViewer - graphData type:', typeof graphData);
    console.log('📊 GraphViewer - graphData keys:', graphData ? Object.keys(graphData) : 'null');
    console.log('📊 GraphViewer - graphData.nodes:', graphData?.nodes);
    console.log('📊 GraphViewer - graphData.links:', graphData?.links);
    ...
    console.log('🎨 GraphViewer - Datos validados:', validatedData ? 'VÁLIDOS' : 'USANDO DEFAULT');
    console.log('🎨 GraphViewer - Datos finales a usar:', JSON.stringify(currentGraphData, null, 2));
    console.log('🔹 GraphViewer - ¿Usando datos reales?', !!validatedData);
    console.log('🔹 GraphViewer - Nodes count:', currentGraphData.nodes?.length);
    console.log('🔹 GraphViewer - Links count:', currentGraphData.links?.length);
